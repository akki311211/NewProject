...
/**
 *  The CustomFormFieldsDAO for the CUSTOM_FORM_FIELDS table
 *
 *@author     Pritish
 *@created    Fri Aug 27 15:36:00 IST 2004
 */
public class CustomFormFieldsDAO extends BaseDAO {
	/**
	*  Constructor for the CustomFormFieldsDAO object
	*/
	public CustomFormFieldsDAO() {
		this.tableAnchor = "customFormFields";
