...
*/
    ...
    public static Info getColumnValueInfo(String tableName, String columnName1, String columnName2, String keyColumn, String key, String columnForOrder, String sortOrder, boolean applyLanguageUtil) {
        ...
        try {
            ...
            while (result.next()) {
                info.set(result.getString(columnName1), applyLanguageUtil ? LanguageUtil.getString(result.getString(columnName2)) : LanguageUtil.getString(result.getString(columnName2)));
            }
        } catch (Exception e) {
            logger.error("ERROR: exception in getColumnValue ::" , e);
            e.printStackTrace();
