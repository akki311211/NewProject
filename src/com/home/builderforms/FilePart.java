 ...
 *
 * A
 * <code>FilePart</code> is an upload part which represents a
 *
...
public class FilePart extends Part {
    ...
    static Logger logger = Logger.getLogger(FilePart.class);
    /**
...
//            e.printStackTrace();
            logger.error("Exception in FilePart--", e);
            partInput = null;
        }
    }
     ...
     *
     * transmit the file; that is available from the
     * <code>getName</code>
     *
     * method.
     *
     *
     *
     * @return name of file uploaded or
     * <code>null</code>.
     *
     *
     *
     ...
     *
     *
     * @return path of file uploaded or
     * <code>null</code>.
     *
     *
     *
     ...
     *
     * there will be
     * <code>0</code> bytes in the input stream.
     *
     ...
     *
     * Returns
     * <code>true</code> to indicate this part is a file.
     *
     *
     *
     * @return true.
